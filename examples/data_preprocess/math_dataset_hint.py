...
def make_prefix(question, hint, template_type):
    # NOTE: also need to change reward_score/countdown.py
    if template_type == 'base':
        if hint:
            prefix = PROMPT_FORMAT_HINT.format(question=question, hint=hint)
        else:
            prefix = PROMPT_FORMAT.format(question=question)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/home/anikait.singh/rl_behaviors/data_math_hint')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--template_type', type=str, default='base')

    args = parser.parse_args()

    data_source = 'Asap7772/math-rag-ai2_math_llamagen_mc'
    ...
    def make_map_fn(split):
        ...
        def process_fn(example, idx):
            ...
            hint = example.pop('hint')

            # question = question + ' ' + instruction_following
            question = make_prefix(question, hint, template_type=args.template_type)
