...
export N_GPUS=4
export BASE_MODEL=/scr/kanishkg/ba/models/countdown_qwen2.5-3b_all_strategies_sft/global_step_60
export DATA_DIR=/scr/kanishkg/countdown
export ROLLOUT_TP_SIZE=2
export EXPERIMENT_NAME=countdown_qwen2.5-3b_all_strategies_sft
