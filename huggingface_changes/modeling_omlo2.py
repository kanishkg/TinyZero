...
_CHECKPOINT_FOR_DOC = "allenai/OLMo-2-1124-7B"
...
### Anikait -> Added below to support sequence classification, token classification and question answering tasks
...
# TODO: re-enable check: Copied from transformers.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->OLMO2,Llama->Olmo2
class Olmo2ForQuestionAnswering(Olmo2PreTrainedModel):
    base_model_prefix = "transformer"

    # Copied from transformers.models.bloom.modeling_bloom.BloomForQuestionAnswering.__init__ with Bloom->Llama
    def __init__(self, config):
        super().__init__(config)
        self.transformer = Olmo2Model(config)
...
# TODO: re-enable check: Copied from transformers.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->OLMO2,Llama->Olmo2
class Olmo2ForTokenClassification(Olmo2PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.model = Olmo2Model(config)
...
__all__ = ["Olmo2ForCausalLM", "Olmo2ForSequenceClassification", "Olmo2ForQuestionAnswering", "Olmo2ForTokenClassification", "Olmo2Model", "Olmo2PreTrainedModel"]
